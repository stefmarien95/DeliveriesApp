...
namespace DeliveriesApp.iOS
{
	public partial class ViewController : UIViewController
	{
        ...
        private async void SigninButton_TouchUpInside(object sender, EventArgs e)
        {
            ...
            {
                hasLoggedIn = true;
                alert = UIAlertController.Create("Success", "Welkom", UIAlertControllerStyle.Alert);
            }
            else
            {
                alert = UIAlertController.Create("Fout", "inloggen mislukt", UIAlertControllerStyle.Alert);
            }
