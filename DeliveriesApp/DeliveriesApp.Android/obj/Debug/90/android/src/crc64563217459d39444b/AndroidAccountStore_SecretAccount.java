...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Xamarin.Auth._MobileServices.AndroidAccountStore+SecretAccount, Microsoft.WindowsAzure.Mobile.Ext", AndroidAccountStore_SecretAccount.class, __md_methods);
	}
	...
	public AndroidAccountStore_SecretAccount ()
	{
		...
		if (getClass () == AndroidAccountStore_SecretAccount.class)
			mono.android.TypeManager.Activate ("Xamarin.Auth._MobileServices.AndroidAccountStore+SecretAccount, Microsoft.WindowsAzure.Mobile.Ext", "", this, new java.lang.Object[] {  });
	}
